...
class CollectorTests(unittest.TestCase):
 ...
 def test_independent_cache_uses_latest_rows_not_historical_seed(self):
  with tempfile.TemporaryDirectory() as folder:
   ...
   config={'version':2,'task_state':save(root/'tasks.json',state),'slack':{'cache_dir':str(slack)},'modules':{'data':save(root/'modules.json',{'world_id':'example-world','generated_at_utc':at,'snapshot_at_utc':'2026-09-18T11:55:00Z','n_hours':1,'window_start_local':'2026-09-18 00','modules':[]})}}
